...
class HeaderKu extends Component{
    ...
    renderLinkIsAgent = () => {
        ...
        if(this.props.role === "BAN"){
        
            return (
                <NavItem>
                    <Link to="/"><NavLink className="myLogin btn btn-default " style={{fontSize:"14px"}}> You got banned</NavLink></Link>
                </NavItem>
            )

        }else if(this.props.role !== "User" && this.props.role !== "Admin" ){
            return(
                            ...
                            <Nav className="ml-auto" navbar>
                                ...
                                <UncontrolledDropdown nav inNavbar>
                                    ...
                                    <DropdownMenu right>
                                        ...
                                        {this.editProfile()}   
                                        <a href='https://api.whatsapp.com/send?phone=6281295678931'>
                                            <DropdownItem >
