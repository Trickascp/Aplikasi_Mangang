...
CheckPayment = (id) => {
  ...
  renderPrice = (item) => {
    ...
    if(disc === "-"){
        ...
        <div className="card-price text-center">
          <div className="row justify-content-center">
            <div className="col-12 p-1 text-center">
              {item.price}<span style={{fontSize: '0.8rem'}}>/{time}</span>
            </div>
          </div>
        </div>
      )
      ...
      var discount = Number(disc) / 100
      var harga = item.harga * discount
      harga = item.harga - harga
      harga = `${harga}`

      var kurang =  harga.length - 3
      

      return (
        <div className="card-price text-center">
          <div className="row justify-content-center">
            <div className="col-4 p-1 text-right text-muted" style={{textDecoration: 'line-through', fontSize: '22px'}} >
              {item.price}
            </div>
            <div className="col-8 p-1 text-left">
              {harga.substring(0, kurang)+'K'}<span style={{fontSize: '0.8rem'}}>/{time}</span>
            </div>
          </div>
        </div>
      )
